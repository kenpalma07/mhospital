...
$route['patient/update/(:any)']['GET'] = 'Patient/edit/$1';
$route['patient/destroy/(:any)']['GET'] = 'Patient/delete/$1';
$route['migrate'] = 'Migrate/index';
$route['patient/medical_record']['GET'] = 'Patient/mrecord';
...
// Using Api
$route['api/v1/patient'] = 'Patient/getAllActivePatient';
$route['api/v1/patient/(:any)'] = 'Patient/getPatientById/$1';
$route['api/v1/medicalRecords'] = 'api/v1/MedicalRecord/getMedicalRecord';